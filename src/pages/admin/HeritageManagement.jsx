    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-heritage-red-100 flex items-center justify-center">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-heritage-red-700 text-white rounded-xl hover:bg-heritage-red-800 transition-colors shadow-lg"
        >
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-heritage-red-500 focus:border-heritage-red-500 transition-colors"
        />
      </div>
      ...
      {(isEditing || isCreating) && (
        <div className="bg-white rounded-2xl shadow-elegant border border-heritage-earth-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-heritage-red-500 focus:border-heritage-red-500"
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2.5 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-heritage-red-500 focus:border-heritage-red-500 resize-none"
          ...
          <div className="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-heritage-earth-100">
            ...
            <button
              onClick={handleSave}
              className="flex items-center gap-2 px-6 py-2 bg-heritage-red-700 text-white rounded-xl hover:bg-heritage-red-800 transition-colors"
            >
                      ...
                      <span
                        className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${
                          heritage.rankingType === 'Quốc gia đặc biệt'
                            ? 'bg-heritage-red-100 text-heritage-red-700'
                            : heritage.rankingType === 'Quốc gia'
                            ? 'bg-heritage-gold-100 text-heritage-gold-700'
                            : 'bg-heritage-earth-100 text-heritage-earth-700'
                        }`}
                      >

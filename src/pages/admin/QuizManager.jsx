      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-amber-600 dark:bg-amber-700 text-white rounded-xl hover:bg-amber-700 dark:hover:bg-amber-600 transition-colors shadow-lg"
          >
        ...
        {(isEditing || isCreating) && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-elegant border border-heritage-earth-200 dark:border-gray-700 p-6 theme-transition">
            ...
            <div className="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-heritage-earth-100 dark:border-gray-700">
              ...
              <button
                onClick={handleSave}
                className="flex items-center gap-2 px-6 py-2 bg-amber-600 dark:bg-amber-700 text-white rounded-xl hover:bg-amber-700 dark:hover:bg-amber-600 transition-colors"
              >
                  ...
                  paginatedQuizzes.map((quiz, index) => (
                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="font-medium text-heritage-earth-900 dark:text-gray-100 line-clamp-2">
                          {quiz.question}
                        </div>
                      </td>

    ...
    <div className="min-h-screen bg-heritage-cream-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-heritage-gold-300 text-sm">Thêm, sửa, xóa thông tin nhân vật lịch sử</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-heritage-gold-100 flex items-center justify-center">
            <Users className="w-5 h-5 text-heritage-gold-600" />
          </div>
          <div>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-heritage-gold-600 text-white rounded-xl hover:bg-heritage-gold-700 transition-colors shadow-lg"
        >
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-heritage-gold-500 focus:border-heritage-gold-500 transition-colors"
        />
      </div>
      ...
      {(isEditing || isCreating) && (
        <div className="bg-white rounded-2xl shadow-elegant border border-heritage-earth-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-heritage-gold-500 focus:border-heritage-gold-500"
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2.5 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-heritage-gold-500 focus:border-heritage-gold-500 resize-none"
          ...
          <div className="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-heritage-earth-100">
            ...
            <button
              onClick={handleSave}
              className="flex items-center gap-2 px-6 py-2 bg-heritage-gold-600 text-white rounded-xl hover:bg-heritage-gold-700 transition-colors"
            >
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-heritage-cream-50 border-b border-heritage-earth-200">
                ...
                <th className="text-left px-4 py-3 text-sm font-semibold text-heritage-earth-700 hidden md:table-cell">
                  Quê quán
                </th>
                <th className="text-left px-4 py-3 text-sm font-semibold text-heritage-earth-700 hidden sm:table-cell">
                  Vai trò
                </th>
                <th className="text-left px-4 py-3 text-sm font-semibold text-heritage-earth-700 hidden lg:table-cell">
                  Năm sinh
                </th>
            ...
            <tbody>
              {paginatedPeople.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-4 py-12 text-center text-heritage-earth-500">
                ...
                paginatedPeople.map((person, index) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="font-medium text-heritage-earth-900 line-clamp-1">
                        {person.name}
                      </div>
                    </td>
                    <td className="px-4 py-3 hidden md:table-cell">
                      <div className="text-sm text-heritage-earth-600 line-clamp-1">
                        {person.address || '-'}
                      </div>
                    </td>
                    <td className="px-4 py-3 hidden sm:table-cell">
                      <span className="inline-flex px-2 py-1 text-xs font-medium rounded-full bg-heritage-gold-100 text-heritage-gold-700">
                        {person.role || 'Chưa xác định'}
                      </span>
                    </td>
                    <td className="px-4 py-3 hidden lg:table-cell">
                      <span className="text-sm text-heritage-earth-600">
                        {person.birthYear || '-'}
                      </span>
                    </td>
                    <td className="px-4 py-3">

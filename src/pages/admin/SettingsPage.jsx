    ...
    <div className="min-h-screen bg-heritage-cream-50 dark:bg-gray-900 p-4 sm:p-6 lg:p-8 theme-transition">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-elegant border border-heritage-earth-200 dark:border-gray-700 overflow-hidden">
          <div className="p-4 border-b border-heritage-earth-100 dark:border-gray-700 bg-gradient-to-r from-heritage-cream-50 to-heritage-cream-100 dark:from-gray-800 dark:to-gray-750">
        ...
        {/* Language Settings */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-elegant border border-heritage-earth-200 dark:border-gray-700 overflow-hidden">
          <div className="p-4 border-b border-heritage-earth-100 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-750">
            <div className="flex items-center gap-3">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-elegant border border-heritage-earth-200 dark:border-gray-700 overflow-hidden">
          <div className="p-4 border-b border-heritage-earth-100 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-gray-800 dark:to-gray-750">
            <div className="flex items-center gap-3">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-elegant border border-heritage-earth-200 dark:border-gray-700 overflow-hidden">
          <div className="p-4 border-b border-heritage-earth-100 dark:border-gray-700 bg-gradient-to-r from-amber-50 to-amber-100 dark:from-gray-800 dark:to-gray-750">
            <div className="flex items-center gap-3">

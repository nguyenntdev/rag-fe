      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors bg-white"
          />
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-2.5 border border-heritage-earth-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 resize-none"
